...
class CustomDataset(Dataset):
    feature_matrix: Tensor # (N, sensors, T)
    label_vector: Tensor
    device: str
    ...
    def __init__(self, segments: Sequence[DataSegment], pipeline: Optional[Pipeline] = None) -> None:
        ...
        self.feature_matrix: Tensor = tensor(concatenate(matrices, axis=0))
    ...
    def __getitem__(self, index):
        return self.feature_matrix[index,:,:], self.label_vector[index]
